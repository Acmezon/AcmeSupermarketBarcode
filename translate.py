...
def translate_to_binary(lines_spaces_vector):
	...
	if len(np.where(np.logical_or(lines_spaces_vector < 1,lines_spaces_vector > 4))[0]):
		print("Error")
...
def translate(vector):
	...
	if len(vector)==95 and np.array_equal(vector[0:3],np.array([1.,0.,1.])) and np.array_equal(vector[-3:],np.array([1.,0.,1.])) and np.array_equal(vector[3+6*7:(3+6*7)+5],np.array([0.,1.,0.,1.,0.])):
		...
		for group in range(0, 6):
			...
			if left[0]==0 and right[0]==1 and np.sum(left)%2!=0 and np.sum(right)%2==0:
...
vector = np.array([1,  1,  1,  3,  2,  1,  1,  1,  4,  1,  1,  1,  1,  1,  4,  3,  2,  1,  1,  3,  2,  1,  1,  3,  2,  1,  1,  1,  1,  1,  1,  1,  2,  1,  2,  2,  3,  1,  1,  2,  2,  2,  2,  1,  1,  1,  3,  2,  1,  2,  3,  1,  2,  1,  2,  2,  1,  1,  1,])
y = translate(vector)